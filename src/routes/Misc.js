    ...
    return (
        <ContentContainer>
            ...
            <ul className="list-disc space-y-4 pl-6">
                ...
                <li>I'm a huge fan of investing, both in stocks and crypto. Part of my morning routine is checking each market! For a while, I was a senior analyst at <a className="underline text-link" href="https://www.brownhealthcareinvestmentgroup.com/" target="_blank" rel="noopener noreferrer">BHIG</a> focused on small-cap pharma equities.</li>
                <li>I'm an amateur house DJ - did my first party at Harvard in September '23, and have since spun the NeurIPS Huggingface afterparty, as well as Cerebral Valley's e/acc holiday party, Apple Vision Pro launch party (covered by the SF Standard <a className="underline text-link" href="https://sfstandard.com/2024/02/24/san-francisco-vision-pro-parties-trend/">here</a>!), and the <a className="underline text-link" href="https://twitter.com/cerebral_valley/status/1778187849248153705">YC W24 afterparty</a> at the top of Transamerica Pyramid!</li>
                <li>I love <a className="underline text-link" href="https://en.wikipedia.org/wiki/Electronic_dance_music" target="_blank" rel="noopener noreferrer">EDM</a>. I've attended EZOO (2x), Countdown, EDC Las Vegas, Escape, Beyond Wonderland, Breakaway Carolina, Breakaway Boston, Daytrip Seattle, Zombie Apocalypse, Wobbleland, and Hard Summer, and many independent shows. My favorite festival of all time was Burning Man 2024.</li>
            </ul>
        </ContentContainer>
    );
}
