    ...
    return (
        <ContentContainer>
            ...
            <ul className="list-disc space-y-4 pl-6">
                <li>I'm a Co-Founder of <a className="underline text-link" href="https://cerebralvalley.ai" target="_blank" rel="noopener noreferrer">Cerebral Valley</a>, I spend my time working on search, backend, scraping, and other misc engineering, as well as leading government / defense efforts in the org. In spare time, I organize events and other ops.</li>
