                    ...
                    <div className="centered-list">
                        <div className="bullet-list-container">
                            <ul>
                                ...
                                <li>
                                    <a className="link" href="https://github.com/raghavpillai/eXpect" target="_blank" rel="noopener noreferrer">eXpect</a>: agentic simulation to predict sentiment and responses from your own X followers for any poll or post. 2nd place in the first <a className="link" href="https://x.ai" target="_blank" rel="noopener noreferrer">x.ai</a> hackathon, featured on their main account <a className="link" href="https://x.com/xai/status/1846989686549696900" target="_blank" rel="noopener noreferrer">here</a>.
                                </li>
                                <li>
                                ...
                                <li>
                                    <a className="link" href="https://github.com/cerebralvalley/compute-boilerplate" target="_blank" rel="noopener noreferrer">Instant LLM API</a>: boilerplate code to turn any VM into a suite of inference and fine tuning endpoints for any Huggingface LLM, fully compatible with the <a className="link" href="https://github.com/meta-llama/llama-stack" target="_blank" rel="noopener noreferrer">Llama stack</a>, in a few hundred lines of code.
                                </li>
                                <li>
